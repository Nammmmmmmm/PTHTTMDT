...
const EditProductModal = ({ product, onClose, onUpdate }) => {
    ...
    const handleDeleteProduct = async () => {
        ...
        try {
            ...
            console.log('Đang xóa sản phẩm:', editingProduct.name, 'ID:', editingProduct._id);
            ...
            const updatedProduct = await ApiService.put(`/product/edit/${editingProduct._id}`, productToDelete);
            ...
            setFormErrors({
                submit: 'Lỗi khi xóa sản phẩm: ' + (error.response?.data?.message || error.message || error)
            });
        } finally {
            setLoading(false);
        }
