      ...
      <div className="mx-auto max-w-7xl py-12 grid grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="space-y-2 text-gray-700">
            ...
            <p className="font-semibold text-purple-600">Hotline: +84 333 265 466</p>
            <p>Km10 Trần Phú, Hà Đông, Hà Nội</p>
            <p>datatienfw@gmail.com</p>
            <p>ta.dat123@gmail.com</p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-700 mb-4">
            Với 20.000 khách hàng đã đăng ký với TMDT hãy đăng ký 
